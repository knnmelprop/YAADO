...
ComponentStore provides "front-door" validation for the `IADE_Core` framework. 
...
Instead of rigid vehicle templates, IADE uses a pure **Composition** architecture. This folder provides generic physical building blocks that can be snapped together in their YAML files to build any vehicle imaginable (Rockets, UAVs, Airships, etc.).
