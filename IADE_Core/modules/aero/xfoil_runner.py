...
1. Checks :mod:`core.solver_registry` for a registered ``xfoil`` binary.
...
from IADE_Core.FlightDeck.solver_registry import DEFAULT_REGISTRY  # noqa: E402
...
class XFOILAnalysis(BaseAnalysis):
        ...
        for mach in case.mach_list:
            if mach <= MIN_MACH_ABSOLUTE:
                raise ValueError(
                    ...
                    "IADE_Core.modules.stability.barrowman_stability) instead"
                )
    ...
    def execute(self) -> AnalysisResults:
        ...
        Checks :mod:`core.solver_registry` for a registered/available
