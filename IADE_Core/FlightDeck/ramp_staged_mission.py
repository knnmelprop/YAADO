...
from IADE_Core.FlightDeck.mission_builder import MissionBuilder, MissionSegment  # noqa: E402
...
def _estimate_cruise_drag_N(
    ...
    """
    from IADE_Core.modules.propulsion.inlet_performance import isa_atmosphere
...
def _compute_ramjet_design_point() -> dict[str, Any]:
    ...
    try:
        from IADE_Core.modules.propulsion.combustor_nozzle_cycle import (
        ...
        return {
            ...
            "note": (
                ...
                "IADE_Core.modules.propulsion.combustor_nozzle_cycle."
