...
from Hangar.gtm140_drone.drone_schema import UAVConfig, WingConfig
from Hangar.ramjet_rocket.rocket_schema import RocketConfig, RamjetConfig
...
def test_yaml_round_trip(tmp_path: Path) -> None:
    ...
    restored = UAVConfig.from_yaml(yaml_path)
...
def test_from_yaml_ramjet_repo_config() -> None:
    ...
    rocket = RocketConfig.from_yaml(path)
...
def test_inconsistent_solid_rocket_thrust_rejected() -> None:
    ...
    """
    from Hangar.ramjet_rocket.rocket_schema import SolidRocketConfig
...
def test_solid_rocket_propulsion_peak_below_mean_rejected() -> None:
    ...
    """
    from Hangar.ramjet_rocket.rocket_schema import SolidRocketPropulsion
