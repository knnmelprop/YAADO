...
from IADE_Core.modules.wind_tunnel.methods.xfoil.xfoil_runner import (
    MAX_MACH,
    MIN_MACH,
    XFOILAnalysis,
    XfoilCase,
...
def test_main_writes_json_and_png(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import IADE_Core.modules.wind_tunnel.methods.xfoil.xfoil_runner as xfoil_runner_module
