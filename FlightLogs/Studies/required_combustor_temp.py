...
OUTPUT_JSON_PATH = THIS_DIR.parents[2] / "FlightLogs" / "required_combustor_temp_results.json"
OUTPUT_PNG_PATH = THIS_DIR.parents[2] / "FlightLogs" / "required_combustor_temp_comparison.png"
...
def real_drag_at_condition_N(mach0: float, altitude_m: float) -> float:
    ...
    Returns:
        ...
        (body wave + friction + fin wave + base drag, current geometry).
    """
    from FlightLogs.Studies.drag_polar import DragPolarAnalysis
