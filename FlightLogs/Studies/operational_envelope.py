...
from IADE_Core.modules.powerplant.cycle_methods.grzywka import GrzywkaCombustorNozzleAnalysis
from IADE_Core.modules.powerplant.inlet_methods.wedge import mil_e_5007_eta_std
...
VEHICLE_CONFIG_PATH: Path = (
    Path(__file__).resolve().parents[2] / "Hangar" / "ramjet_rocket" / "vehicle_config.yaml"
)
"""Path to the Project B rocket vehicle config (READ ONLY; never modified
by this module)."""

THIS_DIR: Path = Path(__file__).resolve().parent
RESULTS_DIR = THIS_DIR.parents[1] / "FlightLogs"
