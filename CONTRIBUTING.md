...
3. **Architecture Mirroring:** The `tests/` directory must perfectly mirror the directory structure of the main codebase. If you create a new module at `YAADO_Core/modules/powerplant/valves.py`, its tests must live at `tests/YAADO_Core/modules/powerplant/test_valves.py`.