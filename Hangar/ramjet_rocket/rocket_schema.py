...
from IADE_Core.Inspectors.vehicle_schema import BaseVehicleConfig, MassProperties
...
class RamjetConfig(BaseModel):
    ...
    nozzle_throat_diameter_m: Union[float, None] = Field(default=None, gt=0.0)
    nozzle_exit_diameter_m: Union[float, None] = Field(default=None, gt=0.0)
...
class BodyConfig(BaseModel):
    ...
    nose_length_m: Union[float, None] = Field(default=None, gt=0.0)
    nose_diameter_m: Union[float, None] = Field(default=None, gt=0.0)
    total_length_m: Union[float, None] = Field(default=None, gt=0.0)
    max_diameter_m: Union[float, None] = Field(default=None, gt=0.0)
...
class FinConfig(BaseModel):
    ...
    chord_root_m: Union[float, None] = Field(default=None, gt=0.0)
    chord_tip_m: Union[float, None] = Field(default=None, ge=0.0)
...
class BoosterGeometry(BaseModel):
    ...
    booster_length_m: Union[float, None] = Field(default=None, gt=0.0)
...
class RocketConfig(BaseVehicleConfig):
    ...
    body: BodyConfig
    fins: FinConfig
    mass_properties: Union[MassProperties, None] = None
