...
THRUST_CURVE_CSV_PATH = (
    REPO_ROOT / "vehicles" / "ramjet_rocket" / "motor_data" / "PRD-240_thrust_curve.csv"
)

#: Non-official vehicle config for this mission (see module docstring).
COLDFLOW_VEHICLE_CONFIG_PATH = (
    REPO_ROOT / "vehicles" / "ramjet_rocket" / "vehicle_config_coldflow_PRD240.yaml"
)
...
OUTPUT_JSON_PATH = THIS_DIR / "coldflow_boost_results.json"
OUTPUT_PNG_PATH = THIS_DIR / "coldflow_boost_trajectories.png"
