...
``vehicles/ramjet_rocket/fusion_extraction_v6.yaml``). At the cruise
...
from core.solver_registry import DEFAULT_REGISTRY  # noqa: E402
        ...
        for mach in case.mach_list:
            if mach <= MIN_MACH_ABSOLUTE:
                raise ValueError(
                    ...
                    "analyses.stability.barrowman_stability) instead"
                )
