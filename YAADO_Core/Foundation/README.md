...
This directory contains the core abstractions and data contracts for the entire `YAADO_Core` framework. All custom physics solvers, structural modules, and mission tools across the repository are built on top of these base classes.
...
`YAADO_Core` acts as a user-friendly superstructure over the highly complex `SUAVE` flight mechanics engine.
