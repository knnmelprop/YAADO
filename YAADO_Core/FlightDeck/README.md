...
1. **Mission Orchestration (SUAVE):** Uses SUAVE to "fly" the vehicle through a trajectory. It executes the mission by attaching high-fidelity surrogate maps (generated by our `modules/`) to the vehicle.
