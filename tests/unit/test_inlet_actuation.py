...
from analyses.propulsion.inlet_actuation import (
    ConeActuationScheduleAnalysis,
    actuation_range_per_cone_deg,
    build_actuation_schedule,
    mach_band_meeting_mil,
)
from analyses.propulsion.inlet_performance import DEFAULT_N_CONES_M25
...
def test_csv_output_created_with_required_columns(tmp_path) -> None:
    ...
    from analyses.propulsion.inlet_actuation import _write_schedule_csv
