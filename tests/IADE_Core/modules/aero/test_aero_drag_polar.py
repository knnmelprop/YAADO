...
from IADE_Core.modules.aero.drag_polar import (
    MACH_GRID,
    MIN_MACH_ABSOLUTE,
    DragPolarAnalysis,
    base_drag_cd,
...
from IADE_Core.modules.mission.operational_envelope import (
    NIGHT3_ALTITUDE_M,
...
def test_main_writes_csv_and_json(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import IADE_Core.modules.aero.drag_polar as drag_polar_module
