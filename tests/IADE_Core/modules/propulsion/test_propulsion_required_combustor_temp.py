...
from IADE_Core.modules.propulsion.cycle_v2.hp_stream_thrust_cycle import CycleInputs, evaluate_cycle
from IADE_Core.modules.propulsion.cycle_v2.required_combustor_temp import (
    TELTIK_DRAG_N,
