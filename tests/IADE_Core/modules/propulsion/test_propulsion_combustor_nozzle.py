...
from IADE_Core.modules.propulsion.inlet_performance import DESIGN_ALTITUDE_M, MACH_DESIGN
from IADE_Core.modules.propulsion.ramjet_cycle import (
    CP_HOT,
    GAMMA_HOT,
    R_HOT,
    RamjetCycleAnalysis,
)
from IADE_Core.FlightDeck.component_base import AnalysisResults, FidelityLevel
